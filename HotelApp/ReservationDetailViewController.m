...
- (void)viewDidLoad
{
    ...
    [labelDateArrival setText:reservationInfo[@"arrivalDate"]];
    [labelDateDeparture setText:reservationInfo[@"departureDate"]];
    [labelNumberOfPeople setText:reservationInfo[@"numberOfPeople"]];
    [labelRoomCategory setText:reservationInfo[@"roomCategory"]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (tableView == tableViewPrice) {
        ...
        [cell.labelTotalPrice setText:reservationInfo[@"totalPrice"]];
        return cell;
    }
...
- (NSDictionary*)contactsInfoFromPlistNamed:(NSString*)plistName {
    ...
    dictionary = dictionary[@"Contacts"];
    return dictionary[@"contactsInfo"];
}
